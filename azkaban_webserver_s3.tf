...
resource "aws_s3_object" "azkaban_webserver_properties" {
...
resource "aws_s3_object" "azkaban_webserver_start" {
  bucket     = data.terraform_remote_state.common.outputs.config_bucket.id
...
resource "aws_s3_object" "azkaban_webserver_internal" {
  bucket     = data.terraform_remote_state.common.outputs.config_bucket.id
...
resource "aws_s3_object" "azkaban_webserver_jmx_exporter_config" {
  bucket     = data.terraform_remote_state.common.outputs.config_bucket.id
