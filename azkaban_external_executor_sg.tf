...
resource "aws_security_group_rule" "allow_azkaban_external_executor_egress_azkaban_database" {
  description              = "Allows azkaban external executor to access azkaban database"
  type                     = "egress"
  protocol                 = "tcp"
